...
\hline
5 & node placement and rendering & This will allow for visualisation of the data for testing and the nodes are required for the path finder & ongoing & n/a\\ 
\hline
\end{tabular}
\newpage
\section{Conclusions}
