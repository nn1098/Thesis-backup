...
We will now review a number of literary sources which fall within the context of path-finding and procedural content generation to establish how these may be used within the project to either help implementation or optimisation of the project in it's latter stages.  
